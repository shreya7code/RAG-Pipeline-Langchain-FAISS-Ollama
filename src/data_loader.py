...
def load_all_documents(data_dir: str) -> List[Any]:
    """
    Files from the data directory and converted to LangChain document structure.
    Supported formats: PDF, TXT, Word
    """
